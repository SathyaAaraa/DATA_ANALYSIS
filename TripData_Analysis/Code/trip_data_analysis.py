...
class TripDataAnalysisV1():
    ...
    def analyse_trip_data(self, DBName, CollectionName):
        ...
        """Commented for loop and replaced with list(trip_amount_per_hour_pipeline_cursor)
        ...
        trip_amount_per_hour_pipeline_temp_df = pd.DataFrame(list(trip_amount_per_hour_pipeline_cursor))
        ...
        """Commented for loop and replaced with list(average_tip_amount_cursor)[0]['average_tip_amount']
        ...
        average_tip_amount = list(average_tip_amount_cursor)[0]['average_tip_amount']
